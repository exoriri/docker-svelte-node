...
var app = (function () {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 204, 1, 6149);
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_attributes(div, div_data);
    			add_location(div, file$5, 196, 0, 5982);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 96, 0, 2664);
    			set_attributes(div1, div1_data);
    			add_location(div1, file$4, 122, 0, 3340);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$3, 65, 0, 1861);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const URL = JSON.parse('false') === false ? 'http://localhost:1000' : 'prodIp';

    const selectedMemoryTitle = writable('');

    /* src/routes/memories/Memories.svelte generated by Svelte v3.49.0 */
    const file$2 = "src/routes/memories/Memories.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*memories, setMemoryTitle*/ 5) {
    				each_value = /*memories*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 31, 8, 663);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(31:4) {#if isMemoriesLoading}",
    		ctx
    	});
    ...
    // (35:12) <Link on:click={setMemoryTitle(memory.title)} to={`memories/${memory.id}`}>
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "asdfsfsdfs";
    			t1 = space();
    			add_location(p, file$2, 35, 16, 844);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(35:12) <Link on:click={setMemoryTitle(memory.title)} to={`memories/${memory.id}`}>",
    		ctx
    	});
    ...
    // (34:8) {#each memories as memory, i}
    function create_each_block(ctx) {
    	...
    	link.$on("click", function () {
    		if (is_function(/*setMemoryTitle*/ ctx[2](/*memory*/ ctx[5].title))) /*setMemoryTitle*/ ctx[2](/*memory*/ ctx[5].title).apply(this, arguments);
    	});
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const link_changes = {};
    			if (dirty & /*memories*/ 1) link_changes.to = `memories/${/*memory*/ ctx[5].id}`;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(34:8) {#each memories as memory, i}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*isMemoriesLoading*/ ctx[1]) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			nav = element("nav");
    			h1 = element("h1");
    			h1.textContent = "Мои воспоминания";
    			t1 = space();
    			if_block.c();
    			add_location(h1, file$2, 29, 4, 599);
    			add_location(nav, file$2, 28, 0, 588);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(0, memories = await res.json());
    		$$invalidate(1, isMemoriesLoading = false);
    	});

    	const writable_props = ['navigate', 'location'];
    	...
    	$$self.$inject_state = $$props => {
    		if ('navigate' in $$props) $$invalidate(3, navigate = $$props.navigate);
    		if ('location' in $$props) $$invalidate(4, location = $$props.location);
    		if ('memories' in $$props) $$invalidate(0, memories = $$props.memories);
    		if ('isMemoriesLoading' in $$props) $$invalidate(1, isMemoriesLoading = $$props.isMemoriesLoading);
    	};
    	...
    	return [memories, isMemoriesLoading, setMemoryTitle, navigate, location];
    }

    class Memories extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { navigate: 3, location: 4 });
    		...
    		if (/*navigate*/ ctx[3] === undefined && !('navigate' in props)) {
    			console.warn("<Memories> was created without expected prop 'navigate'");
    		}

    		if (/*location*/ ctx[4] === undefined && !('location' in props)) {
    			console.warn("<Memories> was created without expected prop 'location'");
    		}
    	}

    	get navigate() {
    		throw new Error("<Memories>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set navigate(value) {
    		throw new Error("<Memories>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    /* src/routes/memories/Memory.svelte generated by Svelte v3.49.0 */
    const file$1 = "src/routes/memories/Memory.svelte";
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$1, 34, 4, 696);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Загрузка картинки...";
    			add_location(div, file$1, 51, 12, 1020);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t0 = text(/*selectedTitle*/ ctx[1]);
    			t1 = space();
    			img = element("img");
    			add_location(div, file$1, 43, 8, 825);
    			...
    			attr_dev(img, "alt", "travel-img");
    			add_location(img, file$1, 44, 8, 861);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*selectedTitle*/ 2) set_data_dev(t0, /*selectedTitle*/ ctx[1]);
    ...
    function create_fragment$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*imgUrl*/ ctx[0] !== null) return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			if_block.c();
    			add_location(div0, file$1, 41, 4, 778);
    			attr_dev(div1, "class", "container svelte-bpqtme");
    			add_location(div1, file$1, 39, 0, 747);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	selectedMemoryTitle.subscribe(value => {
    		$$invalidate(1, selectedTitle = value);
    	});

    	image.src = `${URL}/images/${$params.id}`;

    	image.onload = function () {
    		$$invalidate(0, imgUrl = this.src);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('selectedTitle' in $$props) $$invalidate(1, selectedTitle = $$props.selectedTitle);
    	};
    	...
    	return [imgUrl, selectedTitle, params];
    }
    ...
    // (11:2) <Route path="/memories/*">
    function create_default_slot_1(ctx) {
    	let route;
    	let current;

    	route = new Route$1({
    			props: { path: ":id", component: Memory },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:2) <Route path=\\\"/memories/*\\\">",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router: Router$1, Route: Route$1, Link: Link$1, Memories, Memory });
    	return [];
    }
